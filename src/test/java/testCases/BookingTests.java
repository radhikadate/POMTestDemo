...
public class BookingTests {
	...
	public void login() throws IOException {
		...
		LoginPageTest lpt = new LoginPageTest(loginPage);
		lpt.login();
	...
	public void enterDetails() throws IOException {
		...
		FlightFinderPageTest ffpt = new FlightFinderPageTest(flightFinder);
		ffpt.selectDetails();
	...
	public void selectFlight() {
		...
		SelectFlightPageTest sfpt = new SelectFlightPageTest(selectFlight);
		sfpt.select();
	}
	...
	public void bookFlight() throws IOException {
		...
		BookFlightTest bft = new BookFlightTest(bookFlight);
		bft.enterDetails();
